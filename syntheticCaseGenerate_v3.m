...
clear;
load("C:\Users\zljnj\Dropbox\Matlab_Codes\EnsembleLearning_soil moisture\Cubes4BareLC\cubeC_E"); % the forward data I2EM LUT for C-band
load("C:\Users\zljnj\Dropbox\Matlab_Codes\EnsembleLearning_soil moisture\Cubes4BareLC\cubeL_E"); % the forward data I2EM LUT for L-band
...
%L band@23 deg
for i=1:dateNum
[ tbs(i,1),tbs(i,2),tbs(i,3) ] =bsFromCubes( sig(kkk),cl(kkk),mv(i),incid(1),cubeL ); % interpolate the sigmanull from LUTs
end
...
%L band@35 deg
for i=1:dateNum
[ tbs(i,1),tbs(i,2),tbs(i,3) ] =bsFromCubes( sig(kkk), cl(kkk), mv(i),incid(2),cubeL );
end
...
%C band@23 deg
for i=1:dateNum
[ tbs(i,1),tbs(i,2),tbs(i,3) ] =bsFromCubes(sig(kkk),cl(kkk),mv(i),incid(1),cubeC );
end
...
[ tbs(i,1),tbs(i,2),tbs(i,3) ] =bsFromCubes( sig(kkk),cl(kkk),mv(i),incid(2),cubeC );
